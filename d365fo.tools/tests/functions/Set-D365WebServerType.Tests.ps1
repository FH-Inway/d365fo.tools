Describe "Set-D365WebServerType Unit Tests" -Tag "Unit" {
	...
	Describe "Ensuring unchanged command signature" {
		...
		It 'Should have the expected parameter RuntimeHostTypeOption' {
			$parameter = (Get-Command Set-D365WebServerType).Parameters['RuntimeHostTypeOption']
			$parameter.Name | Should -Be 'RuntimeHostTypeOption'
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -RuntimeHostTypeOption
		__AllParameterSets -RuntimeHostTypeOption -Force
		#>
	}
